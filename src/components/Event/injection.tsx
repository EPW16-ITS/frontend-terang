...
const Injection = () => {
  ...
  return (
    <div>
      {/* Main Content */}
      <section className="relative w-full xs:h-[800px] sm:h-[850px] md:h-[900px] xl:h-[1024px] overflow-hidden bg-gradient-to-b from-[#D65263] from-0% via-[#702B34] to-[#1F0C49] to-68%">
        {/* Pattern Background */}
        ...
        <Typography.CrystalUniverseRegular
          level={7}
          className="lg:text-4xl xs:text-xl sm:text-2xl md:text-2xl xl:text-4xl absolute left-1/2 transform -translate-x-1/2 xs:top-[15%] sm:top-[15%] md:top-[15%] xl:top-[11%] text-center z-40 text-[#3A1E77]"
          style={{
        ...
        <div className="md:left-[25%] xs:w-[280px] xs:h-[120px] sm:w-[600px] sm:h-[100px] md:w-[290px] md:h-[230px] lg:w-[490px] lg:h-[249px] xl:w-[600px] xl:h-[349px] 2xl:w-[750px] 2xl:h-[310px] absolute xs:left-1/2 xs:transform xs:-translate-x-1/2 sm:-translate-x-1/2  sm:left-1/2 sm:transform sm:-translate-y-1/2 md:transform md:-translate-y-1/2 xl:left-[27%] lg:left-[30%] 2xl:left-[30%]  xs:top-[20%] sm:top-[30%] md:top-[41%] xl:top-[40%] xl:transform xl:-translate-y-1/2 bg-third-50 z-30"
          ...
          <div className="w-full h-full xs:p-3 sm:p-4 xl:p-16 2xl:p-20 flex items-center justify-center">
            {/* Konten untuk kiri kanan */}
            <Typography.Poppins
              level={5}
              size="base"
              className="text-fourth-400 xs:text-xs sm:text-xs md:text-base lg:text-xl xl:text-2xl 2xl:text-2xl text-justify">
          ...
          <div className="absolute xs:left-[-25px] xs:bottom-[-30px] sm:left-[-20px] sm:bottom-[-18px] md:left-[-40px] md:bottom-[-25px] xl:left-[-50px] xl:bottom-[-30px] xs:w-[65px] xs:h-[38px] sm:w-[90px] sm:h-[38px] md:w-[180px] md:h-[65px] xl:w-[221px] xl:h-[79px] bg-fourth-25 border-4 border-neutral-800 z-50 flex items-center justify-center cursor-pointer hover:opacity-80 transition-opacity"
            style={{
              borderRadius: '45% 55% 48% 52% / 38% 42% 58% 62%',
               ...
               <a
              href="https://forms.gle/AoB4XdM1siViKEKc8"
              target="_blank"
        ...
        <div className="absolute xs:left-1/2 xs:transform xs:-translate-x-1/2 xs:bottom-[35%] sm:left-[10%] sm:bottom-[45%] md:right-[11%] md:left-auto md:transform-none md:bottom-[5%] xl:left-auto xl:transform-none 2xl:left-auto 2xl:transform-none xl:right-[13%] 2xl:right-[19%] xl:bottom-[8%] z-40">
          ...
          <div className="md:flex md:flex-col md:items-center md:justify-center md:relative lg:flex lg:flex-col lg:items-center lg:justify-center lg:relative">
            ...
            <div className="xs:flex md:flex md:gap-4 md:relative lg:flex lg:gap-4 lg:relative">
              <Button.Primary
                type="default"
                suffix={<FaArrowRight size={20} className="xs:size-3 xs:ml-1 sm:ml-2 md:ml-3 lg:ml-2" />}
              ...
              >
                <a href="https://linktr.ee/INJECTIONEPW16" className="xl:text-base lg:text-base xs:text-xs sm:text-xs xs:whitespace-nowrap sm:whitespace-nowrap">KEBUTUHAN</a>
              </Button.Primary>
            </div>
          </div>
        </div>
        ...
        <div className="absolute xs:left-1/2 xs:transform xs:-translate-x-1/2 xs:top-[75%] xs:w-[300px] xs:h-[180px] sm:left-1/2 sm:transform sm:-translate-x-1/2 sm:top-[65%] sm:w-[450px] sm:h-[240px] md:left-1/2 md:transform md:-translate-x-1/2 md:top-[60%] xl:left-[29%] xl:top-[65%] xl:w-[674px] xl:h-[280px] md:w-[150px] md:h-[90px] z-30">
          ...
          <div className="absolute left-1/2 transform -translate-x-1/2 xs:top-[-5%] xs:w-[80px] xs:h-[30px] sm:top-[5%] sm:w-[150px] sm:h-[55px] md:top-[-15%] md:left-[50%] md:w-[150px] md:h-[50px] xl:top-[5%] xl:w-[219px] xl:h-[71px] bg-fifth-400 flex items-center justify-center z-50">
            <Typography.Poppins
              level={1}
              size="lg"
