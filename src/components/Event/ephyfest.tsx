  ...
  return (
    <div>
      ...
      <section className="relative w-full h-[900px] md:h-[950px] xl:h-[1000px] 2xl:h-[1200px] overflow-hidden bg-gradient-to-b from-[#39488E] from-10% via-[#39488E] bg-[#1F0C49] to-90%">
        ...
        {/* Main Content */}
        <div className="relative w-full h-full mt-[10%] sm:mt-[5%] md:mt-[3%] xl:mt-[5%] 2xl:mt-[1%]">
          ...
          <div className="xl:flex xl:flex-row xl:h-[60%] xl:gap-6 xl:mx-[3%] 2xl:flex 2xl:flex-row 2xl:h-[60%] 2xl:gap-6 2xl:mx-[3%]">
            ...
            <div className="relative w-[90%] md:w-[85%] xl:w-1/2 2xl:w-1/2 h-[30%] md:h-[30%] xl:h-full 2xl:h-full mx-[5%] md:mx-[7.5%] xl:mx-0 2xl:mx-0 md:top-[-11%] lg:top-[-12%] xl:top-0 2xl:top-0 xl:flex xl:flex-col xl:justify-center 2xl:flex 2xl:flex-col 2xl:justify-center">
              <Swiper
                ...
                className="w-[85%] sm:w-[55%] md:w-[60%] xl:w-[80%] 2xl:w-[80%] h-[60%] md:h-[65%] xl:h-[100%] 2xl:h-[70%]"
              >
                <SwiperSlide className="flex items-center justify-center">
                  <div className="relative rounded-2xl overflow-hidden w-[315px] h-[200px] md:w-[350px] md:h-[220px] xl:w-[500px] xl:h-[270px] 2xl:w-[450px] 2xl:h-[280px]">
                    <img
          ...
          <div className="xl:flex xl:flex-row xl:h-[35%] xl:gap-6 xl:mx-[3%] xl:mt-[-10%] 2xl:flex 2xl:flex-row 2xl:h-[35%] 2xl:gap-6 2xl:mx-[3%] 2xl:mt-[-5%]">
            ...
            <div className="h-[23%] md:h-[22%] xl:h-full xl:w-1/2 2xl:h-full 2xl:w-1/2 flex flex-col justify-start m-[5%] md:m-[3%] xl:m-0 2xl:m-0">
              ...
              {/* Slider Container */}
              <div className="relative w-full flex-1 xs:mt-[-10%] sm:mt-[-7%] md:mt-[-4%] lg:mt-1 xl:mt-[-10%] 2xl:mt-4 z-40">
                <Swiper
                  onSwiper={(swiper) => {
                ...
                >
                  {mainEventData.map((item) => (
                    <SwiperSlide key={item.id} className="h-full">
                      <div className="xs:w-[127px] xs:h-[127px] sm:h-[127px] sm:w-[228px] md:w-[250px] md:h-[140px] xl:w-[280px] xl:h-[200px] 2xl:w-[320px] 2xl:h-[220px] bg-fourth-25 border-4 border-fifth-25 flex flex-col relative rounded-lg">
            ...
            <div className="relative w-[90%] md:w-[85%] xl:w-1/2 2xl:w-1/2 h-[7%] md:h-[7%] xl:h-full 2xl:h-full m-[5%] md:m-[7.5%] xl:m-0 2xl:m-0 xs:top-[-5%] sm:top-[-5%] md:top-[-7%] xl:top-0 2xl:top-0 xl:flex xl:flex-col xl:justify-center 2xl:flex 2xl:flex-col 2xl:justify-center">
              ...
              {/* Layout untuk kondisi XL dan 2XL - vertical stack */}
              <div className="hidden xl:flex xl:flex-col xl:items-center xl:gap-4 xl:w-full 2xl:flex 2xl:flex-col 2xl:items-center 2xl:gap-6 2xl:w-full">
                {/* Date Component - positioned at top center */}
                <div
                  className="w-[70%] xl:h-[60px] 2xl:w-[70%] 2xl:h-[80px] bg-gradient-to-r from-[#C64C5C] to-[#BA93E5] border-[2px] border-fifth-25 flex items-center justify-center cursor-text"
                  style={{
                    borderRadius: '0 15px 0 15px'
                  }}
                >
                  <FaCalendar className="text-white xl:text-lg 2xl:text-2xl mr-2" />
                  <Typography.Poppins
                    level={10}
                    className="text-white xl:text-2xl 2xl:text-4xl text-center"
                  >
                    25 Oktober 2025
                  </Typography.Poppins>
                </div>
                ...
                <div className="flex items-center justify-center xl:gap-4 2xl:gap-6 w-full">
                  {/* Registration Button */}
                  <Button.Primary
                    type="default"
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <Typography.Poppins level={12} className="xl:text-sm 2xl:text-base">
                        REGISTRATION
                      </Typography.Poppins>
                      <FaArrowRight className="xl:text-sm 2xl:text-base" />
                    </div>
                  </Button.Primary>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <FaBook className="xl:text-sm 2xl:text-base" />
                    </div>
                  </Button.Primary>
                </div>
              </div>

              {/* Layout untuk kondisi selain XL dan 2XL - horizontal layout (existing) */}
              <div className="relative flex items-center w-full h-[60%] md:h-[60%] xl:hidden 2xl:hidden justify-center gap-[2%]">
