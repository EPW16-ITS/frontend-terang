  ...
  return (
    <div className="h-screen w-full bg-gradient-to-b from-primary-400  to-primary-100 ">
      <section className="flex justify-center md:items-start md:px-52 md:mx-auto flex-col w-full h-full gap-5 md:gap-10 px-5">
        <Typography.SuperComic level={7} className="text-white md:text-8xl">COMING SOON!</Typography.SuperComic>
        <Typography.Homica level={8} className="text-white md:text-5xl">We Are Sorry that our website is currently under development. Soon, you will experience our new contents and features.</Typography.Homica>
