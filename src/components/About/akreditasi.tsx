...
const Akreditasi = () => {
    return (
        <div>
            {/* ---------- SECTION 2 ---------- */}
            <div className="overflow-hidden relative min-h-screen w-full bg-gradient-to-b from-[#2F126D] to-[#F85F73] pt-[100px] pb-[20px]">
                {/* Pattern Background */}
...
{/*kotak ungu atas*/}
  ...
  <div className="w-full max-w-[1220px] mx-auto bg-[#4D2C72] border-[2px] border-yellow-400 rounded-md shadow-lg px-4 sm:px-6 lg:px-8 py-8 text-white">
    ...
    {/* Konten Akreditasi */}
    <div className="flex flex-col z-50 lg:flex-row justify-center mb-2 items-start gap-6 mt-8">
      {[
        {
        ...
        },
        {
          ...
          alt: "ASIIN",
          short: "Program Studi Magister (S2) Terakreditasi ASIIN.",
        ...
        },
        {
          ...
          alt: "LAM Teknik",
          short: "Program Studi Sarjana (S1), Program Studi Magister(S2), Program Studi Doktor (S3) Terakreditasi LAM Teknik.",
...
<div className="absolute z-0 top-0 left-0 w-full h-[100px] pointer-events-none bg-gradient-to-b to-transparent from-[#2F126D]/100 "></div>
<div className="absolute z-0 bottom-0 left-0 w-full h-[400px] pointer-events-none bg-gradient-to-b from-transparent to-[#F85F73]/100 "></div>
