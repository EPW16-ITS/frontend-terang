...
import type { CrystalUniverseRegularProps } from "@/types/components/Typography";
 ...
 */
export default function CrystalUniverseRegular({
  children,
  level = 1,
  as = "h1",
  className = "",
  ...
  ...props
}: CrystalUniverseRegularProps): React.ReactElement {
  const textSizeLevel = {
    1: "text-10xl",
    2: "text-9xl",
    3: "text-8xl",
